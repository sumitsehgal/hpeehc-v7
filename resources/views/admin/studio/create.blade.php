        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left" style="padding-top: 7.5px;">Add Studio</h4>
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form action="{{route('admin.studio.store')}}" class="form-horizontal" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('stats') ? ' has-error' : '' }}">
                            <label for="stats" class="col-md-2 control-label col-md-offset-2 ">Tele Consultations Data</label>

                            <div class="col-md-6 ">
                                <input id="stats" type="number" class="form-control" name="stats" value="{{ old('stats') }}" required autofocus>
